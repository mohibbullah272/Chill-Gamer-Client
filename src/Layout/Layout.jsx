...
<h3 className='text-3xl font-bold text-gray-300'>Level Up Your<span className="text-stone-400 font-semibold">
   <Typewriter words={[' Game Tactics',' Focus',' Performance',' Strategy',' Winning Streak']} loop={5} cursor
            cursorStyle='_'
            typeSpeed={70}
            deleteSpeed={50}
            delaySpeed={1000}>
